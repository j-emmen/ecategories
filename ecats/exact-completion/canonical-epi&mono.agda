...
module ecats.exact-completion.canonical-epi&mono where
...
open import ecats.finite-limits.defs.weak-Wlim
...
module can-epi&mono-defs {ℂ : ecategory} (hasfwl : has-fin-weak-limits ℂ) where
  ...
  module canonical-mono {Y : ℂ.Obj} (R : ℂ.PeqOver Y) {X : ℂ.Obj} (lo-cm : || ℂ.Hom X Y ||) where
    private
      ...
      module wW = fwlℂ.wW-of (ℂ.mkspan/ R.%0 R.%1) lo-cm lo-cm
      ...
      cmPeq/ = record
        ...
        where open ecategory-aux-only ℂ
              ...
              τpfl = ~proof
                ...
                R.%0 ∘ R.τ ∘ τmed ∎
              τpfr = ~proof
                lo-cm ∘ wW.πr ∘ τwpb.wπ/₂                                       ~[ ass ⊙ ∘e r wW.sqr-pf ⊙ assˢ ] /
  ...
  module canonical-mono-sp {O1 O2 : ℂ.Obj} (R/ : ℂ.PeqOver O1) (S/ : ℂ.PeqOver O2)
    ...
    private
      ...
      module sp = ℂ.span/ sp/
      module imgR = fwlℂ.wW-of R.sp/ sp.a1 sp.a1
      module imgS = fwlℂ.wW-of S.sp/ sp.a2 sp.a2
      ...
      cmsp-wτ : ℂ.is-wtransitive pb%0 pb%1
      cmsp-wτ = record
               { τwpb = pbwτ
               ...
               where open ecategory-aux-only ℂ
                     ...
                     τRarpf = ~proof R.%1 ∘ imgR.πc ∘ pbHi.wπ//₁ ∘ pbwτ.wπ/₁      ~[ ass ⊙ ∘e r (imgR.sqr-pf ˢ) ⊙ assˢ ] /
                                     sp.a1 ∘ imgR.πr ∘ pbHi.wπ//₁ ∘ pbwτ.wπ/₁   ~[ ∘e (ass ⊙ pbwτ.w×/sqpf ⊙ assˢ) r ] /
                                     sp.a1 ∘ imgR.πl ∘ pbHi.wπ//₁ ∘ pbwτ.wπ/₂   ~[ ass ⊙ ∘e r imgR.sql-pf ⊙ assˢ ]∎
                                     R.%0 ∘ imgR.πc ∘ pbHi.wπ//₁ ∘ pbwτ.wπ/₂ ∎
                     τRar : || ℂ.Hom pbwτ.ul R.τwpb.ul ||
                     τRar = Rτ.w⟨ imgR.πc ∘ pbHi.wπ//₁ ∘ pbwτ.wπ/₁ , imgR.πc ∘ pbHi.wπ//₁ ∘ pbwτ.wπ/₂ ⟩[ τRarpf ]
                     τimgR₀ = ~proof sp.a1 ∘ pb%0 ∘ pbwτ.wπ/₁                 ~[ ∘e assˢ r ⊙ ass ⊙ ∘e r imgR.sql-pf ⊙ assˢ ] /
                                     R.%0 ∘ imgR.πc ∘ pbHi.wπ//₁ ∘ pbwτ.wπ/₁    ~[ ∘e (Rτ.w×/tr₁ τRarpf ˢ) r ] /
                                     R.%0 ∘ Rτ.wπ/₁ ∘ τRar                     ~[ ass ⊙ ∘e r (R.τ-ax₀ ˢ) ⊙ assˢ ]∎
                                     R.%0 ∘ R.τ ∘ τRar ∎
                     τimgR₁ = ~proof sp.a1 ∘ pb%1 ∘ pbwτ.wπ/₂                 ~[ ∘e assˢ r ⊙ ass ⊙ ∘e r imgR.sqr-pf ⊙ assˢ ] /
                                     R.%1 ∘ imgR.πc ∘ pbHi.wπ//₁ ∘ pbwτ.wπ/₂    ~[ ∘e (Rτ.w×/tr₂ τRarpf ˢ) r ] /
                                     R.%1 ∘ Rτ.wπ/₂ ∘ τRar                     ~[ ass ⊙ ∘e r (R.τ-ax₁ ˢ) ⊙ assˢ ]∎
                                     R.%1 ∘ R.τ ∘ τRar ∎
                     τSarpf = ~proof S.%1 ∘ imgS.πc ∘ pbHi.wπ//₂ ∘ pbwτ.wπ/₁        ~[ ass ⊙ ∘e r (imgS.sqr-pf ˢ) ⊙ assˢ ] /
                                     ...
                                     sp.a2 ∘ imgS.πl ∘ pbHi.wπ//₂ ∘ pbwτ.wπ/₂     ~[ ass ⊙ ∘e r imgS.sql-pf ⊙ assˢ ]∎
                                     S.%0 ∘ imgS.πc ∘ pbHi.wπ//₂ ∘ pbwτ.wπ/₂ ∎
                     τSar : || ℂ.Hom pbwτ.ul S.τwpb.ul ||
                     ...
                     τimgS₁ = ~proof sp.a2 ∘ pb%1 ∘ pbwτ.wπ/₂                 ~[ ∘e (∘e r pbHi.sqpf₂ ⊙ assˢ) r ] /
                                     sp.a2 ∘ imgS.πr ∘ pbHi.wπ//₂ ∘ pbwτ.wπ/₂  ~[ ass ⊙ ∘e r imgS.sqr-pf ⊙ assˢ ] /
      ...
      cmsp-a₁ = record
              { hi = imgR.πc ∘ pbHi.wπ//₁
              ; lo = sp.a1
              ; cmptb₀ = ass ⊙ ∘e r (imgR.sql-pf  ˢ) ⊙ assˢ
              ; cmptb₁ = ass ⊙ ∘e r (imgR.sqr-pf  ˢ) ⊙ assˢ
              }
              where open ecategory-aux-only ℂ
      ...
      cmsp-a₂ = record
              { hi = imgS.πc ∘ pbHi.wπ//₂
              ; lo = sp.a2
              ; cmptb₀ = ass ⊙ ∘e r (imgS.sql-pf  ˢ) ⊙ assˢ ⊙ ∘e (pbHi.sqpf₁ ˢ) r
              ; cmptb₁ = ass ⊙ ∘e r (imgS.sqr-pf  ˢ) ⊙ assˢ ⊙ ∘e (pbHi.sqpf₂ ˢ) r
              }
              where open ecategory-aux-only ℂ
    -- end private
